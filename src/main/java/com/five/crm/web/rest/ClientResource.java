...
import com.five.crm.service.ClientService;
import com.five.crm.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.five.crm.domain.Client}.
 */
@RestController
@RequestMapping("/api")
